...
private String estado_certificacion;
...
private String numeroDteCer;
	...
	public String getEstado_certificacion() {
		return estado_certificacion;
	}

	public void setEstado_certificacion(String estado_certificacion) {
		this.estado_certificacion = estado_certificacion;
	}

	public String getNumeroDteCer() {
		return numeroDteCer;
	}

	public void setNumeroDteCer(String numeroDteCer) {
		this.numeroDteCer = numeroDteCer;
	}
}
